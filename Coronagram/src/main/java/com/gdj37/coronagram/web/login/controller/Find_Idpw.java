...
public class Find_Idpw {
	...
	@RequestMapping(value="/find_pws")
	public ModelAndView find_pws(HttpServletResponse response,ModelAndView mav,HttpSession session,@RequestParam HashMap<String,String> params) throws Throwable{	
		System.out.println(params.get("m_nm"));
		System.out.println(params.get("m_id"));
		System.out.println(params.get("email"));
		String msg ="";
		String pw = iServiceFind_Idpw.find_pws(params);
		System.out.println(pw);
		if(pw != null) {
			mav.setViewName("/find_idpw/find_pw");
		}else {
			msg = "잘못된정보입니다";
	...
	public ModelAndView findPws(@RequestParam HashMap<String, String> params, ModelAndView mav) throws Throwable {
