package com.gdj37.coronagram.common.controller;
...
import com.gdj37.coronagram.common.controller.FileUploadController;
import com.gdj37.coronagram.common.CommonProperties;
...
public class FileUploadController {
	...
	public String fileUploadAjax(HttpServletRequest request, 
		...
		try {
			...
			while (iterator.hasNext()) {//다음값 존재 여부 확인
	...
	@RequestMapping(value = "/coronagram/fileUploadAjax2", method = RequestMethod.POST, 
			produces = "text/json;charset=UTF-8")
	@ResponseBody
	public String fileUploadAjax2(HttpServletRequest request, 
							 ModelAndView modelAndView) throws Throwable {
	ObjectMapper mapper = new ObjectMapper();
	HashMap<String, Object> modelMap = new HashMap<String, Object>();
	...
	@RequestMapping(value = "/coronagram/fileUploadAjax3", method = RequestMethod.POST, 
			produces = "text/json;charset=UTF-8")
	@ResponseBody
	public String fileUploadAjax3(HttpServletRequest request, 
							 ModelAndView modelAndView) throws Throwable {
	ObjectMapper mapper = new ObjectMapper();
	HashMap<String, Object> modelMap = new HashMap<String, Object>();
	...
	String uploadExts = CommonProperties.VIDEO_EXT;
	String uploadPath = CommonProperties.FILE_UPLOAD_PATH;
	String fileFullName = "";
